 ...
 */
@Slf4j
public class TagConcurrentConsumerOne {
...
//    private static final String namesrvAddr = "127.0.0.1:30876";
    ...
    public static void main(String[] args) {
        ...
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("GID-WT-Tag-Consumer-1");
        consumer.setNamesrvAddr(namesrvAddr);
        consumer.setConsumeFromWhere(ConsumeFromWhere.CONSUME_FROM_FIRST_OFFSET);
        try {
            consumer.subscribe("Topic-WT-test", "tag1||tag2");
            ...
            consumer.start();
            log.info("Tag consumer One started.");
